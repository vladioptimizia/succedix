...
export default function Footer() {
  ...
  return (
    <footer className="mt-24" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: 'rgba(8,8,8,0.9)' }}>
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2.5 text-sm" style={{ color: '#6b7280' }}>
              <Link href="/#como-funciona" className="hover:text-white transition-colors">{t.footer.companyLinks.howItWorks}</Link>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full inline-block" style={{ background: '#10b981', boxShadow: '0 0 6px #10b981' }} />
              {t.footer.compliance}
            </span>
            <Link
              href="/privacy"
